...
public class GearGroupsResourceTest {
	...
	public void shouldGetGearGroups() throws Throwable {
		...
		// verifications
		assertThat(gearGroups).isNotNull();
		assertThat(gearGroups).onProperty("name").containsOnly(
				"514207b84382ec1fef0000ab", "514208014382ec1fef0000c8", "514212ce500446b64e0000c0");
		assertThat(new GearGroupsAssert(gearGroups)).assertGroup("514207b84382ec1fef0000ab")
				.hasUUID("514207b84382ec1fef0000ab")
				.containsGear("514207b84382ec1fef000098").inState(GearState.IDLE)
				.containsGear("5146f047500446f12d00002e").inState(GearState.BUILDING);
		assertThat(new GearGroupsAssert(gearGroups)).assertGroup("514208014382ec1fef0000c8")
				.hasUUID("514208014382ec1fef0000c8")
				.containsGear("514208014382ec1fef0000bc").inState(GearState.STARTED);
		assertThat(new GearGroupsAssert(gearGroups)).assertGroup("514212ce500446b64e0000c0")
				.hasUUID("514212ce500446b64e0000c0")
				.containsGear("514212ce500446b64e0000b4").inState(GearState.DEPLOYING);
	}
}
